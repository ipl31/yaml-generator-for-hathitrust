...
- **Times**. Always input times in 24-hour format as HH:MM, 08:30 or 20:30 for 8:30 am/pm, for example. These will be combined with dates entered to create a full timestamp.
...
- **What was the time of the scan in 24-hour time, e.g. 09:30 or 15:45?** Gathers the scan time to be combined and turned into a timestamp. Will run basic tests to ensure it's a 24-hour time. Only accepts HH:MM, no AM/PM. Outputs part of `capture_date`.
